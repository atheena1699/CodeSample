...
Note: The input file is not included in the repository due to NDA signed with the source organisation. THe input file is a txt file with nearly 100000 rows of the format 
      timestamp, message. The message is of the format 't'+ ID(3 bytes) + Data Length Count(1byte) + payload (max 8bytes)+ ignore bits[4bytes].
